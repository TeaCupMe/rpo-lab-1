...
Java_com_example_myclient_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_myclient_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_com_example_myclient_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
Java_com_example_myclient_MainActivity_LogUsingJNI(
        JNIEnv *env,
        jclass /* this */,
        jstring str) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_myclient_MainActivity_encrypt(
        JNIEnv *env,
        jclass,
        jbyteArray key,
        jbyteArray data)
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_myclient_MainActivity_decrypt(
        JNIEnv *env,
        jclass,
        jbyteArray key,
        jbyteArray data)
...
Java_com_example_myclient_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
